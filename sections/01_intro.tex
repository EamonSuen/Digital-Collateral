...
\begin{frame}{文献简介}
  \begin{itemize}
    ...
    \item 进程：2021年4月NBER工作论文，2023年7月修订，2024年正式发表
 ...
 \medskip
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item \textcite{elum2018analysis} 的调查表明，抵押品要求是尼日利亚农户获得正式信贷的重要障碍之一。
    \end{itemize}
  \end{itemize}
  \end{block}
...
\begin{frame}[allowframebreaks]{问题}
    ...
    \end{questionblock}
  \input{tables/digital-vs-traditional.tex}
   ...
   \begin{questionblock}
      ...
      \begin{itemize}
        \item 是否有助于还款义务的履行？
        \item 是否会恶化家庭的资产负债表？
        \item 数字担保贷款是否构成一个可持续的均衡合约，即贷款人愿意提供、借款人愿意接受，并且贷款人能够从中获得非负利润的合约设计？
        \item 是否改善了福利水平？
      \end{itemize}
  \end{questionblock}
\end{frame}
